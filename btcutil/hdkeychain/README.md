...
[![GoDoc](http://img.shields.io/badge/godoc-reference-blue.svg)](http://godoc.org/github.com/btcsuite/btcd/btcutil/v2/hdkeychain)
...
```bash
$ go get -d github.com/btcsuite/btcd/btcutil/v2/hdkeychain@latest
```
